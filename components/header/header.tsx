...
export default function Header() {
  return (
    <>
      ...
      >
        <div className="mask fixed z-[999] w-full bg-opacity-80 text-white">
          <div className="flex w-full items-center justify-between px-6">
            <div className="flex">
              ...
              <div
                ...
                className="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full overflow-y-auto bg-white p-4 transition-transform dark:bg-gray-800"
                tabIndex="-1"
          ...
          <div className=" duration-50 transition hover:border-b-[2px] hover:border-gray-400 hover:bg-gray-100 hover:text-black">
            <Navigation />
          </div>
        </div>
      </div>
